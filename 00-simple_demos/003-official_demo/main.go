// 官方示例，通过 CLI 来启动 worker 和 sender
package main
...
import (
	...
	exampletasks "demo/sourcecode/machinery/v2/example/tasks"
	"demo/sourcecode/machinery/v2/example/tracers"
...
func startServer() (*machinery.Server, error) {
	...
	// lock := eagerlock.New()
	lock2 := redislock.New(cnf, []string{"localhost:6379"}, 0, 0)
	server := machinery.NewServer(cnf, broker, backend, lock2)
